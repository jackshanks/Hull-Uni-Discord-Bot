...
class AssignColour(commands.Cog):
    ...
    @nextcord.slash_command(name="assign-colour", description="Assign yourself a colour",
                            guild_ids=[testserverid])  #ConfigLoader.Config.config.get("guildids")])
    ...
    @nextcord.slash_command(name="remove-colour", description="Go back to your default colour",
                            guild_ids=[testserverid])  #ConfigLoader.Config.config.get("guildids")])
